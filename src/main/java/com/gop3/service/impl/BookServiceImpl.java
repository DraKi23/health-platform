...
public class BookServiceImpl implements BookService {
   ...
   /* public Boolean handleBook(String doctor_openid, String mother_openid, String bookTime, int isReturn) {
    ...
    public Boolean handleBook(BookHandleDTO bookHandleDTO) {
        int doctorId = doctorMapper.getDoctorIdByOpenid(bookHandleDTO.getDid());
        int motherId = motherMapper.getMotherIdByOpenid(bookHandleDTO.getMid());
        return bookMapper.updateBookState(doctorId, motherId, bookHandleDTO.getBookTime(), bookHandleDTO.getIsReturn());
    }
}
